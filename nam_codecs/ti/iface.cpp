...
Engine_Handle InterfaceClass::GetDSPHandle()
{
    Engine_Error        ec;

    TRACE(INFO, _b("GetDSPHandle IN"));
    ...
    TRACE(INFO, _b("GetDSPHandle OUT"));
 ...
 * closing.
 */
void InterfaceClass::FreeDSPHandle(Engine_Handle h)
{
    TRACE(INFO, _b("FreeDSPHandle IN"));
    ...
    TRACE(INFO, _b("FreeDSPHandle OUT"));
}
