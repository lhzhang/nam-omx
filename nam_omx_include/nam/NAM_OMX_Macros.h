...
#ifndef NAM_OMX_MACROS
#define NAM_OMX_MACROS
...
#define INIT_SET_SIZE_VERSION(_struct_, _structType_)               \
    do {                                                            \
        NAM_OSAL_Memset((_struct_), 0, sizeof(_structType_));       \
 ...
 * Port Specific
 */
#define NAM_TUNNEL_ESTABLISHED 0x0001
#define NAM_TUNNEL_IS_SUPPLIER 0x0002
...
#define CHECK_PORT_TUNNELED(port)                      (port->tunnelFlags & NAM_TUNNEL_ESTABLISHED)
#define CHECK_PORT_BUFFER_SUPPLIER(port)               (port->tunnelFlags & NAM_TUNNEL_IS_SUPPLIER)
