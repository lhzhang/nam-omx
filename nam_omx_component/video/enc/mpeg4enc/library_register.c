...
OSCL_EXPORT_REF int NAM_OMX_COMPONENT_Library_Register(NAMRegisterComponentType **ppNAMComponent)
{
    ...
    NAM_OSAL_Strcpy(ppNAMComponent[0]->componentName, NAM_OMX_COMPONENT_MPEG4_ENC);
    NAM_OSAL_Strcpy(ppNAMComponent[0]->roles[0], NAM_OMX_COMPONENT_MPEG4_ENC_ROLE);
    ppNAMComponent[0]->totalRoleNum = MAX_COMPONENT_ROLE_NUM;

    /* component 2 - video encoder H.263 */
    NAM_OSAL_Strcpy(ppNAMComponent[1]->componentName, NAM_OMX_COMPONENT_H263_ENC);
    NAM_OSAL_Strcpy(ppNAMComponent[1]->roles[0], NAM_OMX_COMPONENT_H263_ENC_ROLE);
