...
/*
 * @file       NAM_OMX_Resourcemanager.h
 * @brief
...
#ifndef NAM_OMX_RESOURCEMANAGER
#define NAM_OMX_RESOURCEMANAGER
...
struct NAM_OMX_RM_COMPONENT_LIST;
typedef struct _NAM_OMX_RM_COMPONENT_LIST
{
    OMX_COMPONENTTYPE         *pOMXStandComp;
    OMX_U32                    groupPriority;
    struct NAM_OMX_RM_COMPONENT_LIST *pNext;
} NAM_OMX_RM_COMPONENT_LIST;
